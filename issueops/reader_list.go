...
// ListIdentityFilters selects issue identity and ownership values.
type ListIdentityFilters struct {
...
// ListLabelFilters selects issues by their labels.
...
// ListTextFilters selects issues by textual fields.
type ListTextFilters struct {
...
// ListTimeFilters selects timestamp ranges.
type ListTimeFilters struct {
...
// ListProjectionOptions controls presence predicates and result hydration.
type ListProjectionOptions struct {
	EmptyDesc  bool
	NoAssignee bool
	NoLabels   bool
	SkipLabels bool
...
// ListPriorityFilters selects exact or bounded priorities.
type ListPriorityFilters struct {
...
// ListVisibilityOptions controls which normally hidden issue classes appear.
type ListVisibilityOptions struct {
...
// ListRelationFilters selects parent and molecule relationships.
type ListRelationFilters struct {
	ParentID string
	NoParent bool
	MolType  *MolType
...
// ListStateFilters selects deferred, overdue, and metadata state.
type ListStateFilters struct {
	DeferredFlag bool
	OverdueFlag  bool
...
// ListModeOptions selects the high-level listing mode.
type ListModeOptions struct {
...
// ListPageOptions controls ordering, pagination, and defensive row limits.
