...
import (
	...
	"github.com/jonbaldie/beads/internal/workapi/storereadycounter"
	"github.com/jonbaldie/beads/issueops"
)

// ReadyCounter returns the guarded ready-count surface for this store.
func (s *DoltStore) ReadyCounter() (issueops.ReadyCounter, error) {
...
func newReadyCounter(store *DoltStore) (issueops.ReadyCounter, error) {
	if store == nil {
