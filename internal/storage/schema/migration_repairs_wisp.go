...
func ensureDependenciesIDPrimaryKey(ctx context.Context, db DBConn) error {
	if err := rejectUnbackfilledDependencyIDs(ctx, db); err != nil {
		return err
	}
	...
	if err := replaceDependencyPrimaryKey(ctx, db); err != nil {
		return err
	}
...
func rejectUnbackfilledDependencyIDs(ctx context.Context, db DBConn) error {
...
func replaceDependencyPrimaryKey(ctx context.Context, db DBConn) error {
...
func ensureWispDependenciesSplitTargets(ctx context.Context, db DBConn) error {
	...
	if err := ensureWispDependencyTargetColumns(ctx, db); err != nil {
		return err
	}
	return backfillWispDependencyTargets(ctx, db)
}

func ensureWispDependencyTargetColumns(ctx context.Context, db DBConn) error {
...
func backfillWispDependencyTargets(ctx context.Context, db DBConn) error {
